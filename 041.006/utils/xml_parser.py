...
def parse_law_xml(xml_data, terms, unit):
    ...
    articles = tree.findall(".//조문") or tree.findall(".//조문단위") or tree.findall(".//조항")
    ...
    for article in articles:
        ...
        title = article.findtext("조문제목", "") or article.findtext("조제목", "") or ""
        content = article.findtext("조문내용", "") or article.findtext("항내용", "") or ""
